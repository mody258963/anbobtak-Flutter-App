        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              context.read<EmailAuthCubit>().signup(namecontroller.text, emailcontroller.text, passwordcontroller.text, cpasswordcontroller.text);
                        }, 'Sign Up')),
                    SizedBox(
                      height: 30,
                    ),
                        ...
                        child: Center(
                            child: TextButton(
                                ...
                                child: Text(
                                  "Sign In",
                                  style: TextStyle(
                                      color: Color.fromRGBO(49, 39, 79, .6),fontSize: width * 0.04),
                                )))),
                  ],
                ),
              )
